...
[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://urban-air-quality-intelligence-platform.streamlit.app)
...
**[→ Open the interactive dashboard](https://urban-air-quality-intelligence-platform.streamlit.app)**
...
urban-air-quality-intelligence-platform/
│
├── notebooks/                              # Phase-by-phase analysis (all outputs committed)
│   ├── 01_data_acquisition.ipynb          # UCI loading + OpenAQ API v3 data fetch
...
│
├── data/
│   ├── raw/                               # ⚠ Gitignored — download manually (see Setup)
│   │   └── AirQualityUCI.xlsx            # Place here before running Phase 1
│   └── processed/                         # Auto-generated by notebooks — committed
│       ├── feature_cols.json             # Ordered feature column list (46 features)
│       ├── scaler.pkl                    # Fitted StandardScaler from Phase 3
│       ├── train.csv                     # Training split (70%, ~2,501 rows)
│       ├── val.csv                       # Validation split (15%, 536 rows)
│       ├── test.csv                      # Test split (15%, 536 rows)
│       ├── features_full.csv             # Full feature-engineered dataset
│       ├── shap_values_cls.npy           # Cached SHAP values — classifier
│       └── shap_values_reg.npy           # Cached SHAP values — regressor
│
├── models/                                # Committed — needed by Streamlit Cloud app
│   ├── xgb_classifier.pkl                # XGBoost AQI classifier (86.6% accuracy)
│   └── xgb_regressor.pkl                 # XGBoost NO₂ regressor (R²=0.885)
│   # Note: rf_*.pkl and dummy_*.pkl are gitignored (too large / not needed by app)
│
├── outputs/                               # Charts auto-generated by notebooks (PNG)
│   ├── 01_missing_values_uci.png         # Phase 1: missing value analysis
│   ├── 01_openaq_no2_preview.png         # Phase 1: OpenAQ live data preview
│   ├── 02_pollutant_distributions.png    # Phase 2: distribution histograms
│   ├── 02_hourly_patterns.png            # Phase 2: rush-hour pollution peaks
│   ├── 02_weekly_patterns.png            # Phase 2: weekday vs weekend patterns
│   ├── 02_seasonal_patterns.png          # Phase 2: seasonal pollution cycles
│   ├── 02_correlation_heatmap.png        # Phase 2: feature correlation matrix
│   ├── 02_sensor_vs_truth.png            # Phase 2: sensor vs ground truth scatter
│   ├── 02_openaq_country_comparison.png  # Phase 2: IT · FR · DE comparison
│   ├── 03_cyclical_encoding_explainer.png # Phase 3: why sin/cos encoding matters
│   ├── 03_aqi_class_distribution.png    # Phase 3: AQI category class balance
│   ├── 03_train_val_test_split.png      # Phase 3: time-aware split visualisation
│   ├── 04_confusion_matrices.png        # Phase 4: RF vs XGBoost confusion matrix
│   ├── 04_predicted_vs_actual.png       # Phase 4: regression predicted vs actual
│   ├── 04_model_comparison.png          # Phase 4: all models side-by-side
│   ├── 05_shap_global_importance.png    # Phase 5: global feature importance bar chart
│   ├── 05_shap_beeswarm.png             # Phase 5: beeswarm plot (all predictions)
│   ├── 05_waterfall_correct_poor.png    # Phase 5: local explanation — correct "Poor"
│   ├── 05_waterfall_correct_good.png    # Phase 5: local explanation — correct "Good"
│   ├── 05_waterfall_misclassified.png   # Phase 5: local explanation — misclassified
│   ├── 05_shap_dependence_plots.png     # Phase 5: non-linear feature relationships
│   └── 05_shap_regression_importance.png # Phase 5: regression SHAP importance
│
├── app.py                                 # Streamlit dashboard (4 pages)
├── requirements.txt                       # Deployment-safe dependencies (12 packages)
├── runtime.txt                            # Python 3.11 pin for Streamlit Cloud
├── .streamlit/
│   └── config.toml                        # App theme — no headless setting (Cloud-safe)
├── .env.example                           # API key template (safe to commit)
├── .env                                   # ⚠ Gitignored — your real API key (never commit)
└── README.md
```

> **Note for reviewers cloning this repo:** All notebooks are pre-executed with outputs committed — you can read every result, chart, and table on GitHub without running any code. To re-run the full pipeline, follow the Setup section below.
